...
# Name: Daniel Taylor
# Date: 1/5/22
# Description: I added more rooms. The rooms I added also make the building
# three dimensional. I also added a snake which when picked up bites you 
# and kills you.
######################################################################
...
def createRooms():
    ...
    # add exits to room 5
    r5.addExit("down-stairs", r1)
    r5.addExit("east", r6)
    r5.addExit("south", r7)
    # add grabbables to room 5
    r5.addGrabbable("snake")
    # add items to room 5
    r5.addItem("snake_terrarium", "It contains a snake.")
    # add exits to room 6
    r6.addExit("west", r5)
    r6.addExit("south", r8)
    # add exits to room 7
...
while (True):
    ...
    if "snake" in inventory:
        status = "You were bitten by a poisonous snake and died"
    ...
    if status == "You were bitten by a poisonous snake and died":
        death()
        break
